...
const PostModal = ({ isOpen,  children, title, description }: any) => {
  return (
    <div>
      {isOpen && (
        <div className="overflow-y-auto overflow-x-hidden fixed inset-0 flex items-center justify-center z-50 w-full h-screen bg-gray-600 bg-opacity-20 backdrop-blur-sm">
