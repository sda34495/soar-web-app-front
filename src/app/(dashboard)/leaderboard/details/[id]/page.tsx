  ...
  <div className="p-6 border border-zinc-800 space-y-6 max-w-30 sm:max-w-[30rem] bg-[#141414] rounded-3xl shadow-lg">
    {error ? (
      ...
      <>
        ...
        <div className="flex flex-col sm:flex-row sm:gap-6 items-center sm:items-start relative">
          {/* Avatar Section */}
          <div className="relative w-24 h-24 sm:w-32 sm:h-24">
            <img
              src={userData.avatar}
          ...
          {/* User Info Section */}
          <div className="flex flex-col sm:flex-row sm:gap-6 items-center sm:items-start mt-4 sm:mt-0 w-full">
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              {/* Position */}
              <div className="flex items-center gap-2">
                <p className="font-bold text-3xl sm:text-5xl">{userData.position}</p>
        ...
        <div className="text-lg space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="font-semibold text-gray-300">Total Check-ins</span>
            <span className="font-semibold text-xl">
          ...
          <div className="flex items-center justify-between">
            ...
            <span>{userData.weekly_check_ins}</span>
          </div>
        </div>

        {/* Instruction Text */}
        <p className="text-sm text-gray-400 mt-4">
          Complete the check-ins and increase your points to get a better position.
        </p>
      </>
    ) : (
