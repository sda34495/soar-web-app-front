  ...
  return (
    <div>
      {isOpen && (
       ...
       <div className="relative p-4 w-full max-w-lg h-auto mx-4 my-auto flex justify-center items-center">
         <div className="relative p-4 bg-[#202020] rounded-3xl shadow-md md:p-8 border border-[#7c7c7c] text-center w-full max-w-lg mx-auto">
